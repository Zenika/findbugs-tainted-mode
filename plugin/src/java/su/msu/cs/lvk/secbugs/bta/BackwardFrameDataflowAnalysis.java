 ...
 * @author Igor Konnov
 */
public abstract class BackwardFrameDataflowAnalysis<ValueType, FrameType extends Frame<ValueType>>
        extends BackwardDataflowAnalysis<FrameType> {
    public BackwardFrameDataflowAnalysis(ReverseDepthFirstSearch rdfs, DepthFirstSearch dfs) {
        super(rdfs, dfs);
    }
